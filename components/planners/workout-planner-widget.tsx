  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        <div className="w-14 h-14 bg-gradient-to-br from-[#7FB069] to-[#E26C73] rounded-full flex items-center justify-center mx-auto mb-3">
          <Dumbbell className="h-7 w-7 text-white" />
        </div>
        <h3 className="text-2xl font-bold text-[#7FB069] mb-1">Movement Intention™</h3>
        <p className="text-gray-500 text-sm">Set your intention, then live it.</p>
      </div>
        ...
        <Card className="border-2 border-[#7FB069]/30">
          <CardContent className="pt-6 pb-6 space-y-6">
            <div>
              ...
              <h4 className="text-xl font-bold text-gray-800 mb-1">Set My Movement Intention™</h4>
