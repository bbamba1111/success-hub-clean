...
/**
 * CEO Workday Activities Form — Decide → Populate → Execute
 * ---------------------------------------------------------------------------
 * Lets the founder decide today's CEO Workday™ activities in advance, inside
 * the "4-Hour Focused CEO Workday" collapsible tab of Design My Work-Life
 * Balance Business Day™. Reads/writes the same `TodaysPlanRecord` the real
 * CEO Workday™ segment displays later, so nothing is re-entered.
 *
...
export function CeoWorkdayActivitiesForm() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <span className={`font-sans text-xs font-semibold ${ceoOverCap ? "text-[#C13B6B]" : "text-[#6B5860]"}`}>
