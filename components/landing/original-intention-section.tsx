...
export function OriginalIntentionSection() {
  return (
    <section id="intention" className="w-full bg-[#DCE5D5] py-20 sm:py-28">
      <div className="mx-auto max-w-4xl px-5 sm:px-8">
        ...
        >
          <span className="font-poppins inline-flex items-center rounded-full bg-[#4A5D45]/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-[#4A5D45]">
        ...
        >
          {INTENTIONS.map((item) => (
            <li
              key={item}
              className="font-poppins rounded-full border border-[#4A5D45]/20 bg-white px-4 py-2 text-sm font-medium text-[#4A5D45]"
            >
              {item}
            </li>
          ))}
        ...
        <motion.div
          ...
          className="mx-auto mt-12 max-w-2xl border-t border-[#B7C4AC] pt-8"
        >
