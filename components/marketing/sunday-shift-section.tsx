...
export function SundayShiftSection() {
  return (
    <section id="sunday-shift" className="py-28 bg-gradient-to-br from-[#E7EDDB] via-white to-[#F0F7F4]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          <p className="font-montserrat text-xl lg:text-2xl text-[#2F4F4F] max-w-4xl mx-auto leading-relaxed">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-[#7FB069] rounded-3xl p-8 text-white shadow-xl">
            ...
            <p className="font-montserrat text-xl text-white/95 leading-relaxed">
          ...
          <div className="bg-[#E26C73] rounded-3xl p-8 text-white shadow-xl">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="bg-[#C25A60] text-white text-sm font-montserrat font-medium px-4 py-1 rounded-full">
                Step 2
              </span>
            </div>
          ...
          <div className="bg-gradient-to-br from-[#7FB069] via-[#A08060] to-[#E26C73] rounded-3xl p-8 text-white shadow-xl">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="bg-white/30 text-white text-sm font-montserrat font-medium px-4 py-1 rounded-full">
                Step 3
              </span>
            </div>
