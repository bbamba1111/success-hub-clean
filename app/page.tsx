          ...
          <div className="py-20 bg-gradient-to-br from-[#7FB069]/10 to-white">
            <div className="max-w-7xl mx-auto px-6">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                {/* Right: Content */}
                <div className="order-1 lg:order-2 space-y-6">
                  <h2 className="text-4xl lg:text-5xl font-bold text-[#7FB069]">Take Guilt-Free Sabbaticals</h2>
                  <p className="text-xl text-gray-700 leading-relaxed">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Use our sabbaticals as permission to fully disconnect, knowing the entire community is stepping away
                    together. No FOMO, no guilt — just rest.
                  </p>
      ...
      <div className="py-20 bg-gradient-to-br from-[#7FB069]/10 to-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Right: Content */}
            <div className="order-1 lg:order-2 space-y-6">
              <h2 className="text-4xl lg:text-5xl font-bold text-[#7FB069]">Rest, Recover & Recharge Unapologetically</h2>
              <p className="text-xl text-gray-700 leading-relaxed">
                We don't just teach Work-Life Balance — <span className="font-bold text-[#7FB069]">we live it</span>. That's why we take two community-wide sabbaticals every year.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
