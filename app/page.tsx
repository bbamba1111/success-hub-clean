  ...
  <div className="flex flex-col lg:flex-row items-center gap-8">
    <div className="lg:w-2/3 text-white">
      <h3 className="text-2xl font-bold mb-4">
        <strong>Monthly Membership - Stay Connected</strong>
      </h3>
      <p className="mb-4 italic text-white/90">Keep Your Momentum with Ongoing Support</p>
      <p className="mb-4 leading-relaxed text-white/90">
        Perfect for maintaining your Work-Life Balance transformation after completing an experience. Stay connected with the community, access ongoing resources, and keep your rhythms strong with 3 Mondays per month.
      </p>
