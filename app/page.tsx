          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            <Card className="bg-white border-2 border-[#7FB069]/20 hover:shadow-xl transition-all">
              <CardHeader>
                ...
                <CardTitle className="text-2xl font-bold text-[#7FB069]">
            ...
            <Card className="bg-white border-2 border-[#E26C73]/20 hover:shadow-xl transition-all">
              <CardHeader>
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#7FB069] to-[#E26C73] flex items-center justify-center mb-4 text-3xl">
                  🤖
                </div>
                <CardTitle className="text-2xl font-bold text-[#E26C73]">
                  15 AI Executives
                </CardTitle>
              </CardHeader>
              <CardContent>
                ...
                <Link href="/ai-executive-team">
                  <Button className="w-full bg-[#E26C73] hover:bg-[#D55A60] text-white font-semibold text-lg py-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="bg-white border-2 border-[#7FB069]/30">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl font-bold text-[#7FB069]">
                    You - The 20%
                  </CardTitle>
              ...
              <Card className="bg-white border-2 border-[#E26C73]/30">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl font-bold text-[#E26C73]">
                    AI Team - The 80%
                  </CardTitle>
