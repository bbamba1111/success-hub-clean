...
export async function POST(req: Request) {
  try {
    ...
    const welcomePrompts: Record<string, string> = {
      audit:
        "Hello, I'm Cherry Blossom, your work-life harmony co-guide. 🌸\n\nWelcome to your Work-Life Balance Audit Review - a sacred moment of self-awareness and transformation.\n\n**What You're About to Do:**\nReview your audit results across 13 Core Life Value Areas and select 1-3 priority areas to transform over the next 28 days.\n\n**Why This Matters:**\n**Spiritually:** Self-awareness is the first step to transformation. This audit reveals where you're out of alignment with your divine design.\n**Scientifically:** When you identify specific imbalances, your reticular activating system (RAS) begins noticing solutions and rewiring your brain for alignment.\n\n**How This Benefits You:**\nClarity on where to focus, understanding what's draining your energy, immediate micro-actions to start shifting today, and your roadmap to sustainable success.\n\nNow, let's dive into your results! Share your audit scores and I'll help you create your personalized harmony plan.\n\n*Want to learn more about the spiritual and scientific foundations of this process? Just ask!*",
      intentions:
        "Hello, I'm Cherry Blossom, your work-life harmony co-guide. 🌸\n\nWelcome to the 28-Day Desired Work-Lifestyle Intention Setting Process - a sacred spiritual and scientific practice of quantum alignment.\n\n**What You're About to Do:**\nCraft a powerful intention declaration using the 6-Step Intention Setting Process. This combines gratitude, intention, vision, and divine alignment to manifest your desired work-lifestyle.\n\n**Why This Matters:**\n**Spiritually:** Matthew 7:7 says, 'Ask, and it shall be GIVEN to you.' When you speak your intention aloud, you're planting an invisible seed into the spiritual realm.\n**Scientifically:** You're programming your nervous system for success through heart-brain coherence, neural pathway activation, and somatic integration.\n\n**The GIVEN Framework:**\nGratitude + Invitation & Intention + Vision & Visualization + Emotional Embodiment + Nurture = Manifestation\n\n**How This Benefits You:**\nAlignment with divine will, clarity on your desired reality, elevated energy frequency, magnetic attraction of opportunities, community support, and activation of spiritual and scientific laws of creation.\n\nAre you ready to begin the 6-Step Intention Setting Process?\n\n*Want to learn more about the spiritual science and electro-magnetic equation of manifestation? Just ask!*",
    }
