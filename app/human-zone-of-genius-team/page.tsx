...
import { Brain, Users, Clock, TrendingUp, Zap } from 'lucide-react'
...
export default function HumanZoneOfGeniusPage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section - Soft Sage Green Background */}
      <div style={{ backgroundColor: "#E8F3E8" }} className="py-16">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Your Human Zone of Genius</h1>
          <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto leading-relaxed">
            In the age of AI, your human skills are your greatest competitive advantage. Discover and develop your 8
            irreplaceable human-only business skills.
          </p>
      ...
      {/* 8 Human Skills Section - Soft Pink Background */}
      <div style={{ backgroundColor: "#FDE8E8" }} className="py-16">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Your 8 Human-Only Business Skills</h2>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                title: "Authentic Relationships",
                description: "Building genuine connections that AI cannot replicate",
              },
              ...
              { title: "High-Value Sales", description: "Consultative selling and closing transformational deals" },
              {
                ...
                description: "Creating original insights and content that positions you as an authority",
              },
              { title: "Coaching Delivery", description: "Transformational client work that requires human intuition" },
              {
                ...
                description: "Creative solutions that go beyond algorithmic thinking",
              },
      ...
      {/* Command Center Section - Soft Sage Green Background */}
      <div style={{ backgroundColor: "#E8F3E8" }} className="py-16">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Your Command Center Above the AI Team</h2>
            ...
            <Card className="bg-gradient-to-br from-green-50 to-blue-50 border-2 border-green-200">
              ...
              <CardContent>
                <p className="text-gray-700 mb-4 leading-relaxed">
                  ...
                  bookkeeping, transcription, proposals, social media, and operational execution.
                </p>
      ...
      <div style={{ backgroundColor: "#F5E6D3" }} className="py-16">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">4 Hours is Your Sweet Spot</h2>
          <p className="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto leading-relaxed">
            Monday through Thursday, 1:00-5:00 PM EST is your structured 4-hour workday focused entirely on the 20% of
            work that generates 80% of your results while AI handles the rest.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="bg-white border-2 border-gray-200">
              ...
              <CardContent>
                <p className="text-gray-700 leading-relaxed">
                  Each business day, the AI tells you exactly what needle-moving action to focus on for maximum leverage
            ...
            <Card className="bg-white border-2 border-gray-200">
              ...
              <CardContent>
                <p className="text-gray-700 leading-relaxed">
                  The AI team educates you daily on what's happening in your business, showing your accomplishments and
                  guiding you to 6, 7, 8 figure+ revenue.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white border-2 border-gray-200">
              ...
              <CardContent>
                <p className="text-gray-700 leading-relaxed">
                  Your structured 4-hour workday focused entirely on the 20% of work that generates 80% of your results
      ...
      <div className="bg-white py-16">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Why Top Coaches Choose This Approach</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-2 border-gray-200 bg-gradient-to-br from-gray-50 to-white">
              ...
              <CardContent>
                <p className="text-gray-700 leading-relaxed">
                  15 business executives (COO to Graphic Designer) for comprehensive support across all business
                  functions.
                </p>
              </CardContent>
            </Card>
      ...
      <div style={{ backgroundColor: "#E8F5E9" }} className="py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Ready to Plan Your 4-Hour CEO Workday?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/ai-executive-team">
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-purple-500 text-purple-700 hover:bg-purple-50 font-bold px-8 py-6 text-lg w-full sm:w-auto bg-transparent"
              >
      ...
      <div style={{ backgroundColor: "#F5E6D3" }} className="py-16">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <Card style={{ backgroundColor: "#FDE8E8" }} className="border-2 border-gray-200">
              <CardHeader>
            ...
            <Card style={{ backgroundColor: "#E8F3E8" }} className="border-2 border-gray-200">
              <CardHeader>
                <div className="flex items-center gap-3 mb-3">
      ...
      <ZoneOfGeniusChatModal isOpen={isChatOpen} onClose={() => setIsChatOpen(false)} />
    </div>
  )
}
