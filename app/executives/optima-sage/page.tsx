...
export default function OptimaSagePage() {
  const executive = getExecutive("optima-sage")
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50/30 py-12 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Optima Sage</h1>
          <p className="text-xl text-gray-600">COO - Operations Optimization</p>
        </div>
