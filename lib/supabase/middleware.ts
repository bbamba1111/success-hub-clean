...
const PUBLIC_ROUTES = [
  ...
  "/marketing",
  "/landing",
  // "/1day" — the $1,997 live group "Make Time For More on Mondays™"
  // offer landing page. Public because it's a pre-purchase
  // marketing/checkout page, not gated app content.
  "/1day",
  "/sunday-shift",
  "/garden",
  "/audit",
