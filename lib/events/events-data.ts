...
export const EVENTS_CATALOG: HarmonyEvent[] = [
  {
    ...
    seats: "Open",
    joinHref: "https://join.butter.us/make-time-for-more/4-hour-workday",
    accentColor: "#5D9D61",
    tintRgb: "238 247 239",
  ...
  },
  {
    ...
    seats: "Open",
    joinHref: "https://www.facebook.com/groups/maketimeformore",
    accentColor: "#4A7FA5",
    tintRgb: "236 244 251",
    requiresRegistration: false,
    prepItems: [
  ...
  },
  {
    ...
    seats: "Open",
    joinHref: "https://join.butter.us/make-time-for-more/morning-routine",
    accentColor: "#8AAF8C",
    tintRgb: "239 246 240",
    requiresRegistration: false,
    prepItems: [
