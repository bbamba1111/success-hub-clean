  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FAF7F2] to-[#F8C8C8]/20 flex items-center justify-center px-6">
      <div className="max-w-lg mx-auto text-center">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-[#2F4F4F] mb-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/audit">
            <Button className="bg-[#7FB069] hover:bg-[#6FA055] text-white px-8 py-6 text-lg font-semibold rounded-full">
              Take The Audit Now
            </Button>
          </Link>
          <Link href="/">
            <Button 
              variant="outline"
              className="border-2 border-[#7FB069] text-[#7FB069] hover:bg-[#7FB069] hover:text-white px-8 py-6 text-lg font-semibold rounded-full"
            >
              Return to Home
            </Button>
          </Link>
