...
const questions = [
  ...
  },
  {
    ...
    question:
      "In the past 30 days, how often have you shared your expertise through partnerships, collaboration, public speaking or publishing?",
  },
  {
    id: 10,
    category: "financial",
    question:
      "In the past 30 days, how often have you focused intentionally on income/revenue generation, financial planning, or retirement planning?",
  },
  {
    id: 11,
            ...
            <CardContent className="p-8">
              ...
              <div className="text-center mb-8">
                <p className="text-lg text-gray-700 mb-4">
                  {results.overallScore >= 80
                    ...
                    : results.overallScore >= 70
                      ? "You're on the right track! Let's elevate it to the next level together."
                      : "Great awareness! Recognizing these areas is the first step toward transformation."}
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="border-[#E26C73] text-[#E26C73] hover:bg-[#E26C73] hover:text-white px-8 py-3"
                >
