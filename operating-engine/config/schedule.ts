...
export const SCHEDULE: BlockConfig[] = [
  ...
  // Appears after the Reality Check™ on Mondays only (10:30–11:00 AM).
  {
    ...
    title: "Decide My Priority Focus Areas For The Week™",
    shortTitle: "Decide My Priority Focus Areas For The Week™",
    ...
    cta: "Decide My Priority Focus Areas™",
    engagement: "self-guided",
    part: "morning",
    greetingPeriod: "Morning",
    greetingEmoji: "🌸",
  ...
  // locked until the next Monday.
  {
    ...
    title: "Decide & Design Your Work-Life Balance Business Day™",
    shortTitle: "Decide & Design Your Business Day™",
    timeLabel: "9:45–10:30 AM",
    startMinutes: h(9, 45),
    endMinutes: h(10, 30),
    description:
